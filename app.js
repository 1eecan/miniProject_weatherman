...
function weather(nx, ny) {
  fetch(
    `https://apis.data.go.kr/1360000/VilageFcstInfoService_2.0/getVilageFcst?serviceKey=${config.apikey}&pageNo=1&numOfRows=229&dataType=JSON&base_date=20230604&base_time=0500&nx=${nx}&ny=${ny}`
  )
    .then((res) => res.json())
    .then(function (data) {
